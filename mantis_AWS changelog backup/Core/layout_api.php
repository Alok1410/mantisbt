...
function layout_footer() {
	...
	echo '<address>' . "\n";
	echo '<strong>Powered by <a href="https://www.matrixnmedia.com/" title="Matrix Bug Tracker">Matrix Media Pvt Ltd.' . $t_version_suffix . '</a></strong> <br>' . "\n";
	echo "<small>Copyright &copy;$t_copyright_years Matrix Team</small>" . '<br>';
	...
	if( !is_page_name( 'login_page' ) ) {
		...
		echo '<a href="https://www.matrixnmedia.com/" '.
			'title="Matrix Bug Tracker">' .
			'<img src="' . $t_mantisbt_logo_url . '" width="102" height="35" ' .
			'alt="Powered by Matrix Media (P.) Ltd" />' .
			'</a>' . "\n";
		echo '</div>' . "\n";
		echo '</div>' . "\n";
	}
